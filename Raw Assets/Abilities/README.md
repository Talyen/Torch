...
| ------------- | ---------------- | ------------------------------------------ |
| `Bash.jpeg`   | `ability.bash`   | Trinket `Raw Assets/Abilities/Bash.jpeg`   |
| `Sunder.jpeg` | `ability.sunder` | Trinket `Raw Assets/Abilities/Sunder.jpeg` |
| `Avatar.jpeg` | `ability.avatar` | Trinket `Raw Assets/Abilities/Avatar.jpeg` |
